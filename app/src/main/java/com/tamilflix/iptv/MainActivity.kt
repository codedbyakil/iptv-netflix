...
sealed class Screen { object Home : Screen(); object Settings : Screen(); data class Player(val channel: Channel) : Screen() }
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(Unit) { channels = M3uParser.fetchChannels(); darkTheme = AppSettings.darkModeFlow.first() }
